...
{
    public class ShopManager : IServiceInitialisable, IDisposable,IShopService
    {
        ...
        public ShopManager(ShopConfig shopConfig,IIapBrigde iapBridge, ISaveSystem saveSystem, IEventService eventService, 
