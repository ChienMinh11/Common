    ...
    public class ResourceManager : IResourceService, IDisposable
    {
        ...
        public IResourcePresenter RegisterView(string resourceKey, IResourceView view)
        {
            ...
            if (presenter != null)
            {
                ...
                // Lắng nghe event từ presenter vừa tạo để phát ngược ra ngoài
                presenter.OnPendingUpdatesProcessed += HandlePresenterPendingUpdatesProcessed;

                if (view is IResourceView regenView)
                {
                    var regenPresenter = new ResourceRegenPresenter(regenView, resourceKey, this);
        ...
        public void UnregisterPresenter(IResourcePresenter presenter)
        {
            ...
            {
                longPresenter.OnPendingUpdatesProcessed -= HandlePresenterPendingUpdatesProcessed;

                if (longPresenter.View != null && _activeRegenPresenters.TryGetValue(longPresenter.View, out var regenPresenter))
                {
