...
namespace ChieChie.Resource
{
    public class ResourceUpdateQueue
    {
        ...
        public ResourceUpdateData ProcessNextUpdate(string resourceKey)
        {
            if (updateQueue.Count > 0 && !isProcessing)
            {
                isProcessing = true;
                ...
                isProcessing = false;
                return new ResourceUpdateData(resourceKey, nextAmount);
            }
    ...
    public class ResourceUpdateData
    {
        ...
        public ResourceUpdateData(string resourceKey, long amount)
        {
